page 97890 "Application Payments Subform"
{
    AutoSplitKey = true;
    DelayedInsert = true;
    PageType = ListPart;
    ...
    layout
    {
        area(content)
        {
            ...
            group("Payment Information")
            {
                ...
                field(TotalApplAmt; TotalApplAmt)
                {
                    Editable = false;
                }
                field(TotalRcvdAmt; TotalRcvdAmt)
                {
                    Editable = false;
                }
                field("TotalApplAmt -TotalRcvdAmt"; TotalApplAmt - TotalRcvdAmt)
                {
                    Editable = false;
                    Style = Strong;
                    StyleExpr = TRUE;
