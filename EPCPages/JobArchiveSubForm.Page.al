page 97802 "Job Archive SubForm"
{
    ...
    var
        TempProjectTask: Record "EPC Job Task Archive" temporary;
    ...
    var
        ProjectTask: Record "EPC Job Task Archive";
    begin
    ...
    local procedure IsExpanded(ActualProjectTask: Record "EPC Job Task Archive"): Boolean
    begin
    ...
    local procedure GetEndTotal(var ProjectTask: Record "EPC Job Task Archive"): Text[250]
    var
        ProjectTask2: Record "EPC Job Task Archive";
    begin
    ...
    begin
        //CurrPage.Name.UPDATEINDENT((Indentation) * 220);  // ALLE MM
