page 97829 "Material Return Site/Contracto"
{
    ...
    // //RAHEE1.00 170412 Added code for Transfer to code not be Responsibility Center.
        ...
        area(content)
        {
            group(General)
            {
                ...
                field("Transfer-to Code"; Rec."Transfer-to Code")
                {
                    ...
                    trigger OnValidate()
                    begin
                        IF RespCent.GET(Rec."Shortcut Dimension 1 Code") THEN BEGIN
                            IF Rec."Transfer-to Code" <> RespCent."Subcon/Site Location" THEN
                                ERROR('Transfer-to-code must be same as ' + ' ' + RespCent."Subcon/Site Location");
                        END;
                    end;
                }
        ...
        area(processing)
        {
            ...
            group("F&unctions")
            {
                ...
                action("Get Indent Lines")
                {
                    ...
                    trigger OnAction()
                    begin
                        //CurrPage.TransferLines.PAGE.GetIndentLineInfo;
                    end;
                }
            }
            group("P&osting")
    ...
    begin
        ...
        //RAHEE1.00 170412
        //IF RespCenter.GET("Transfer-from Code") THEN BEGIN
        //  VALIDATE("Transfer-to Code",RespCenter."Subcon/Site Location");
        //END;
        //RAHEE1.00 170412
    ...
    var
        ...
        RespCent: Record "Responsibility Center 1";
