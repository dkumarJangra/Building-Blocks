            ...
            action("&Post")
            {
                ...
                begin
                    IF CustNoFilter = '' THEN
                        ERROR('Enter Team Lead');
                    IF ProjectCodeFilter = '' THEN
                        ERROR('Enter Project Code');
                    IF Stdate = 0D THEN
                        ERROR('Enter Upto Date');
                    IF TADocNo = '' THEN
                        ERROR('Enter Document No.');
                    // BBG1.01 261012 END

                    AppTAEntry.RESET;
                    AppTAEntry.SETRANGE("Team Lead", CustNoFilter);
                    AppTAEntry.SETRANGE("Creation Date", Stdate);
                    AppTAEntry.SETRANGE("Project Code", ProjectCodeFilter);
                    AppTAEntry.SETRANGE(Approved, TRUE);
                    AppTAEntry.SETRANGE("Document No.", TADocNo);
                    ...
                    AppTAEntryDet.RESET;
                    AppTAEntryDet.SETRANGE("Associate Code", CustNoFilter);
                    AppTAEntryDet.SETRANGE("Creation Date", Stdate);
                    AppTAEntryDet.SETRANGE("Project Code", ProjectCodeFilter);
                    AppTAEntryDet.SETRANGE("Document No.", TADocNo);
