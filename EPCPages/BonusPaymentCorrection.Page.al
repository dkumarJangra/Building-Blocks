page 97942 "Bonus Payment Correction"
{
    PageType = List;
    UsageCategory = Lists;
    ApplicationArea = All;
        ...
        area(navigation)
        {
            group(Function)
            {
                ...
                action(Post)
                {
                    ...
                    trigger OnAction()
                    begin
                        CLEAR(BonusCorrection);
                        BonusCorrection.BonusCorrection(UnitOfficeCodeCorr, UnitOfficeCode, PaidToCorr, ReceivedFrom, PostedDocNo);
                        COMMIT;
                        UnitOfficeCodeCorr := FALSE;
                        UnitOfficeCode := '';
                        PaidToCorr := FALSE;
                        ReceivedFrom := '';
                        PostedDocNo := '';
    ...
    var
        ...
        BonusCorrection: Codeunit "Bonus Correction";
