page 97980 "Cheque Correction Posted Doc"
{
        ...
        area(content)
        {
            group(General)
            {
                field("Confirmed Order No."; BondNo)
                {
                    ...
                    TableRelation = "Application Payment Entry"."Document No." WHERE("Cheque Status" = FILTER(' '),
                    ...
                    begin
                        IF BondNo <> '' THEN BEGIN
                            ...
                            ApplicationPaymentEntry.SETFILTER("Payment Mode", '<>%1', ApplicationPaymentEntry."Payment Mode"::Cash);
                            ApplicationPaymentEntry.SETFILTER("Document Type", '%1|%2', ApplicationPaymentEntry."Document Type"::Application,
                                                       ApplicationPaymentEntry."Document Type"::BOND);
            ...
            group(Function)
            {
                ...
                action(Post)
                {
                    ...
                    var
                        ...
                        APEntry_1: Record "Application Payment Entry";
                        ...
                        IF CONFIRM('Update cheque details') THEN BEGIN
                            ...
                            IF ApplicationPaymentEntry.FINDSET THEN
                                REPEAT
                                    ...
                                    ChequeLength := 0;
                                    ChequeLength := StrLen(ApplicationPaymentEntry."Cheque No./ Transaction No.");
    ...
    var
        ...
        Text19009139: Label 'Customer Cheque Correction in LLP company only................';
