page 50011 "Bank Account No. Correction"
{
            ...
            group(Function)
            {
                ...
                action(Post)
                {
                    ...
                    begin
                        ...
                        IF ApplicationPaymentEntry."Posted Document No." <> '' THEN BEGIN
                            BankAccReconciliationLine.RESET;
                            BankAccReconciliationLine.SETRANGE("Document No.", ApplicationPaymentEntry."Posted Document No.");
                        ...
                        IF CONFIRM('You are going to change Bank A/C from %1 to %2.\Are you sure?', FALSE, NBankNo, BankCode) THEN BEGIN
                            ...
                            IF ApplicationPaymentEntry.FINDSET THEN
                                REPEAT
                                    //ALLECK 170313 START
                                    IF BankAcCrctn THEN BEGIN
                                        ApplicationPaymentEntry."Deposit/Paid Bank" := BankCode;
                                        IF BankAccount.GET(BankCode) THEN
                                            ApplicationPaymentEntry."Deposit / Paid Bank Name" := BankAccount.Name;
                                    ...
                                    NewApplicationPaymentEntry.SETRANGE("Posting date", ApplicationPaymentEntry."Posting date");
                                    ...
                                    IF NewApplicationPaymentEntry.FINDFIRST THEN BEGIN
                                        NewApplicationPaymentEntry."Deposit/Paid Bank" := BankCode;
                                        NewApplicationPaymentEntry."Deposit / Paid Bank Name" := ApplicationPaymentEntry."Deposit / Paid Bank Name";
