page 97956 "MIN Header-Gold/Silver"
{
    ...
    actions
    {
        area(navigation)
        {
            ...
            group("&GIN")
            {
                ...
                {
                    Caption = 'Get Gold/Silver Coins Lines';
                    Image = GetLines;
                    Promoted = true;
                    ...
                    begin
                        ...
                        IF Rec."Item Type" = Rec."Item Type"::Gold THEN BEGIN
                        ...
                        IF Rec."Item Type" = Rec."Item Type"::Silver THEN BEGIN
                            GoldCoinApproval.RESET;
                            CLEAR(GoldCoinApprovalPAGE);
                            GoldCoinApproval.SETRANGE("Customer No.", Rec."Customer No.");
                            GoldCoinApproval.SETRANGE("Gold/Silver Issue Status", GoldCoinApproval."Gold/Silver Issue Status"::Partial);
                            GoldCoinApproval.SETRANGE("Item Type", GoldCoinApproval."Item Type"::Silver);
                            IF GoldCoinApproval.FINDFIRST THEN BEGIN
                                GoldCoinApprovalPAGE.SETTABLEVIEW(GoldCoinApproval);
                                GoldCoinApprovalPAGE.SetDocNo(Rec."Document No.");
                                GoldCoinApprovalPAGE.RUNMODAL;
                        ...
                        IF CONFIRM(txtConfirm, TRUE) THEN BEGIN
                            ...
                            IF GoldCoinApproval.FINDSET THEN
                                REPEAT
                                    ...
                                    IF GoldCoinApproval."Issued Gold / Silver" = GoldCoinApproval."Eligibility Gold / Silver" THEN BEGIN
                            ...
                            UpdateGoldGenerate;  //ALLEDK 260213
    ...
    begin
        IF Rec."Item Type" = Rec."Item Type"::Silver THEN BEGIN
            Rec.TESTFIELD("Silver Gram Eligibility");
