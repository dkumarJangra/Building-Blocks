page 50036 "Auto Rev. Entries-Spcl. Incent"
{
    ...
    begin
        ...
        IF CONFIRM(Txt, FALSE) THEN BEGIN
            ...
            IF VendLE.FINDFIRST THEN BEGIN
                ...
                //CommPayVoucher.GET(VendLE."External Document No.");  //BBG2.00
                CommPayVoucher.SETRANGE("Document No.", VendLE."External Document No.");  //BBG2.00
                IF CommPayVoucher.FINDFIRST THEN BEGIN                                        //BBG2.00
                    IF NOT CommPayVoucher."Invoice Reversed" THEN BEGIN
                        ExtDocNo := VendLE."External Document No.";
                        VendNo := VendLE."Vendor No.";
                        UnitSetup.GET;
                        IF (CommPayVoucher.Type IN [CommPayVoucher.Type::Incentive]) AND
                           (CommPayVoucher."Sub Type" = CommPayVoucher."Sub Type"::Direct) THEN BEGIN
                            CLEAR(VoucherLine);
                            VoucherLine.RESET;
