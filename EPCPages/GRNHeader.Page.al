                ...
                action("Post")
                {
                    ...
                    begin
                        ...
                        IF GRNLine.FINDFIRST THEN BEGIN
                            ...
                            //NoSeriesMgt.InitSeries(PurAndPay."Rejection No. Series",xRec."Rejection No. Series",
                            // WORKDATE,Rec."Rejection Note No.",Rec."Rejection No. Series");  //Old code commented 07032026
