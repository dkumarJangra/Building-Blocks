page 98014 "Unit Payment Entry List"
{
    Editable = false;
    PageType = Card;
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field("App. Pay. Entry Line No."; Rec."App. Pay. Entry Line No.")
                {
                }
                field("Transfered MTM"; Rec."Transfered MTM")
                {
                }
                field("Transfered MTM Received"; Rec."Transfered MTM Received")
                {
                }
                field("Transfered MTM Post"; Rec."Transfered MTM Post")
                {
                }
            }
        }
