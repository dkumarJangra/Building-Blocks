page 98006 "Contra-Bank/Cash Diff Br TFR"
{
    // //SC : Write a code
    ...
    // BBG1.00: AD DATED 010413: On selection of Account Code, the Project Code(Global Dim 1) should be blank
    ...
    layout
    {
        area(content)
        {
            ...
            repeater(Group)
            {
                ...
                field("Account No."; Rec."Account No.")
                {
                    ...
                    begin
                        ...
                        Rec.VALIDATE("Shortcut Dimension 1 Code", '');  //BBG1.00: AD010413
                    end;
                }
            ...
            group(Group2)
            {
                ...
                field("ShortcutDimCode[3] + ' ' + CFDesc"; ShortcutDimCode[3] + ' ' + CFDesc)
                {
                    Caption = 'To Region';
                    Editable = false;
                }
                ...
                // field("Employee No. +' ' + EmpName"; "Employee No." + ' ' + EmpName)
                // {
                //     Caption = 'FA';
                //     Editable = false;
                //     Style = Strong;
        ...
        area(navigation)
        {
            group("&Narration")
            {
                ...
                action("Line Narration")
                {
                    ...
                    RunObject = Page "Gen. Journal Voucher Narration";// "Gen. Journal Narration";// 16572;
    ...
    begin
        ...
        IF OpenedFromBatch THEN BEGIN
            ...
            EXIT;
        END;
        //GenJnlManagement.TemplateSelection(PAGE::98006,0,FALSE,Rec,JnlSelected);
        GenJnlManagement.TemplateSelection(98006, 0, FALSE, Rec, JnlSelected);
