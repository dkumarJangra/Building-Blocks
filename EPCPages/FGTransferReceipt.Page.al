page 97804 "FG Transfer Receipt"
{
    ...
    //  //RAHEE1.00 Change the Property of Approval form (50005-
    //  Key Responsibility Center=FIELD(Responsibility Center) in place of
    //  Key Responsibility Center=FIELD(Transfer-to code))
    // //RAHEE1.00 For check the PO Line no. not be blank in case of PO Code
    // 
    // //RAHEE1.00 230412 Transfer-to code must be same Shortcut dimension1 code
            ...
            group(General)
            {
                ...
                field("Transfer-to Code"; Rec."Transfer-to Code")
                {
                    ...
                    begin
                        ...
                        IF Rec."Transfer-to Code" <> Rec."Shortcut Dimension 1 Code" THEN
                            ERROR('Transfer-to-code not different to ' + ' ' + Rec."Shortcut Dimension 1 Code");
                    end;
                }
        ...
        area(navigation)
        {
            ...
            group("O&rder")
            {
                ...
                action("Co&mments")
                {
                    Caption = 'Co&mments';
                    Image = ViewComments;
                    RunObject = Page "Inventory Comment Sheet";// 5750;
                ...
                {
                    Caption = 'S&hipments';
                    RunObject = Page "Posted Transfer Shipment";// 5752;
                ...
                action("Whse. Shi&pments")
                {
                    ...
                    RunObject = Page "Whse. Shipment Lines";// 7341;
                ...
                action("&Whse. Receipts")
                {
                    ...
                    RunObject = Page "Whse. Receipt Lines";// 7342;
                    RunPageLink = "Source Type" = CONST(5741),
                ...
                action("In&vt. Put-away/Pick Lines")
                {
                    ...
                    RunObject = Page "Warehouse Activity List";// 5774;
        ...
        area(processing)
        {
            ...
            group("F&unctions")
            {
                ...
                action("Re&lease")
                {
                    Caption = 'Re&lease';
                    Image = ReleaseDoc;
                    RunObject = Codeunit "Release Transfer Document"; //5708;
                    ShortCutKey = 'Ctrl+F9';
                }
                action("Reo&pen")
                {
                    ...
                    trigger OnAction()
                    var
                        ReleaseTransferDoc: Codeunit "Release Transfer Document";// 5708;
                    begin
                ...
                action("Get Indent Lines")
                {
                    ...
                    trigger OnAction()
                    begin
                        //CurrPage.TransferLines.PAGE.GetIndentLineInfo; // ALLE MM
                    end;
                }
            }
            group("P&osting")
            {
                ...
                action("P&ost")
                {
                    ...
                    PromotedCategory = Process;
                    PromotedIsBig = true;
                    RunObject = Codeunit "TransferOrder-Post (Yes/No)";// 5706;
                    ShortCutKey = 'F9';
                ...
                action("Post and &Print")
                {
                    ...
                    PromotedCategory = Process;
                    PromotedIsBig = true;
                    RunObject = Codeunit "TransferOrder-Post + Print";// 5707;
    ...
    begin
        ...
        IF UserMgt.GetPurchasesFilter() <> '' THEN BEGIN
            IF RecRespCenter.GET(UserMgt.GetPurchasesFilter()) THEN BEGIN
                Rec.FILTERGROUP(2);
                Rec.SETRANGE("Transfer-from Code", RecRespCenter."Subcon/Site Location");
                Rec.FILTERGROUP(0);
            END;
        END;
        //RAHEE1.00

        //VALIDATE("Transfer-to Code","Shortcut Dimension 1 Code"); //RAHEE1.00 230412
