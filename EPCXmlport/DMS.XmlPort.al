xmlport 50005 "DMSUniversal XMLport"
{
...
tabledata "Purch. Cr. Memo Hdr." = rm,
                ...
                group(Filename)
                {
                    ...
                    field(txtFileName; txtFileName)
                    {
                        ...
                        begin
                            ...
                            UploadIntoStream('Please select file', '', 'All files (*.*)|*.*', ltxtFilename, IStream);
    ...
    begin
        ...
        RecRef.Open(pnTableID);
        txtTableName := RecRef.Name;
