table 50069 "Deactivate Region wise Vendor"
{
    ...
    fields
    {
        ...
        field(50007; "Deactivate Associate Code"; Code[20])
        {
            CalcFormula = Lookup("De-Activate Vendors"."No." WHERE("No." = FIELD("Parent Code")));
            FieldClass = FlowField;
        }
    }
