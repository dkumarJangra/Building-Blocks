table 50071 "Team_Leader wise collection"
{
    ...
    fields
    {
        ...
        field(24; "Associate DOJ"; Date)
        {
            DataClassification = ToBeClassified;
            Editable = false;
        }
        field(25; "Introducer Code"; Code[20])
        {
            DataClassification = ToBeClassified;
            Editable = false;
        }
    ...
    keys
    {
        ...
        key(Key2; "Allotment Extent", "Allotment Collection Amount", "Associate DOJ")
        {
        }
        key(Key3; "Document Type", "Associat Code", "Qualify Associate")
        {
        }
        key(Key4; "Introducer Code")
        {
        }
    }
