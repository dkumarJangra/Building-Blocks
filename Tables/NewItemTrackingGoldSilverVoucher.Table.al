...
table 60715 "Voucher Tracking Specification"
{
    Caption = 'Gold/Silver Tracking Specification';
    ...
    fields
    {
        ...
        field(4; "Quantity (Base)"; Decimal)
        {
            ...
            begin
                ...
                OnValidateQuantityBaseOnBeforeCheckItemTrackingChange(Rec, CurrFieldNo, IsHandled);  //110425
                // if not IsHandled then
                //     WMSManagement.CheckItemTrackingChange(Rec, xRec);  //110425
        ...
        field(38; "Appl.-to Item Entry"; Integer)
        {
            ...
            begin
                ...
                //ItemLedgEntry.SetTrackingFilterFromSpec(Rec);  //110425
        ...
        field(41; "Expiration Date"; Date)
        {
            ...
            begin
                ...
                IsHandled := false;
                OnValidateExpirationDateOnBeforeResetExpirationDate(Rec, xRec, IsHandled); //110425
                if not IsHandled then
                ...
                //if "Expiration Date" <> xRec."Expiration Date" then  //110425
                //ItemTrackingMgt.UpdateExpirationDateForLot(Rec);  //110425
            end;
        }
        field(50; "Qty. to Handle (Base)"; Decimal)
        {
            ...
            begin
                ...
                OnValidateQtyToHandleOnBeforeInitQtyToInvoice(Rec, xRec, CurrFieldNo);  //110425
        ...
        field(5811; "Appl.-from Item Entry"; Integer)
        {
            ...
            begin
                ...
                OnAfterLookupApplFromItemEntrySetFilters(ItemLedgEntry, Rec); //110425
                if PAGE.RunModal(PAGE::"Item Ledger Entries", ItemLedgEntry) = ACTION::LookupOK then
...
#pragma warning restore AA0470
    ...
    begin
        IsHandled := false;
        OnBeforeInitQtyToShip(Rec, IsHandled);  //110425
        if IsHandled then
            exit;
    ...
    begin
        //AssemblyHeaderReserve.InitFromAsmHeader(Rec, AsmHeader); //110425
    end;
#endif
    ...
    begin
        // AssemblyLineReserve.InitFromAsmLine(Rec, AsmLine); //110425
    end;
#endif
    ...
    begin
        // ItemJnlLineReserve.InitFromItemJnlLine(Rec, ItemJnlLine); //110425
    end;
#endif
    ...
    begin
        // InvtDocLineReserve.InitFromInvtDocLine(Rec, InvtDocLine); //110425
    end;
#endif
    ...
    begin
        // JobJnlLineReserve.InitFromJobJnlLine(Rec, JobJnlLine); //110425
    end;
#endif
    ...
    begin
        // JobPlanningLineReserve.InitFromJobPlanningLine(Rec, JobPlanningLine); //110425
    end;
#endif
    ...
    begin
        // PurchLineReserve.InitFromPurchLine(Rec, PurchLine); //110425
    end;
#endif
    ...
    begin
        // ProdOrderLineReserve.InitFromProdOrderLine(Rec, ProdOrderLine); //110425
    end;
#endif
    ...
    begin
        // ProdOrderCompReserve.InitFromProdOrderComp(Rec, ProdOrderComp); //110425
    end;
#endif
    ...
    begin
        // PlngComponentReserve.InitFromProdPlanningComp(Rec, PlanningComponent); //110425
    end;
#endif
    ...
    begin
        // ReqLineReserve.InitFromReqLine(Rec, ReqLine); //110425
    end;
#endif
    ...
    begin
        // SalesLineReserve.InitFromSalesLine(Rec, SalesLine); //110425
    end;
#endif
    ...
    begin
        // ServiceLineReserve.InitFromServLine(Rec, ServiceLine, Consume); //110425
    end;
#endif
    ...
    begin
        // TransferLineReserve.InitFromTransLine(Rec, TransLine, AvalabilityDate, Direction); //110425
    end;
#endif
    ...
    procedure CopySpecification(var TempTrackingSpecification: Record "Voucher Tracking Specification" temporary)
    begin
        Reset();
    ...
    procedure HasSameTracking(TrackingSpecification: Record "Voucher Tracking Specification") IsSameTracking: Boolean;
    begin
        IsSameTracking :=
    ...
    var
        TrackingSpecification: Record "Voucher Tracking Specification";
    begin
        Reset();
    ...
    begin
        ...
        "Expiration Date" := 0D;
        // ItemTrackingMgt.CopyExpirationDateForLot(Rec); //110425
        ...
        if not ItemTrackingCode."Use Expiration Dates" then
            ...
            // ExpDate := ItemTrackingMgt.ExistingExpirationDate(Rec, false, EntriesExist); //110425
        ...
        if IsReclass() then begin
            ...
            // ItemTrackingSetup.CopyTrackingFromNewTrackingSpec(Rec); //110425
    ...
    begin
        ...
        ItemLedgEntry.TestField("Variant Code", "Variant Code");
        // ItemLedgEntry.TestTrackingEqualToTrackingSpec(Rec); //110425
    ...
    procedure CopyTrackingFromTrackingSpec(TrackingSpecification: Record "Voucher Tracking Specification")
    begin
    ...
    procedure CopyNewTrackingFromTrackingSpec(TrackingSpecification: Record "Voucher Tracking Specification")
    begin
    ...
    procedure CopyNewTrackingFromNewTrackingSpec(TrackingSpecification: Record "Voucher Tracking Specification")
    begin
    ...
    procedure SetNewTrackingFilterFromNewTrackingSpec(TrackingSpecification: Record "Voucher Tracking Specification")
    begin
    ...
    procedure SetTrackingFilterFromSpec(TrackingSpecification: Record "Voucher Tracking Specification")
    begin
    ...
    procedure SetNonSerialTrackingFilterFromSpec(TrackingSpecification: Record "Voucher Tracking Specification")
    begin
        SetRange("Lot No.", TrackingSpecification."Lot No.");
    ...
    local procedure OnAfterClearTracking(var TrackingSpecification: Record "Voucher Tracking Specification")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterClearTrackingFilter(var TrackingSpecification: Record "Voucher Tracking Specification")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterCopyTrackingFromReservEntry(var TrackingSpecification: Record "Voucher Tracking Specification"; ReservEntry: Record "Reservation Entry");
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterCopyTrackingFromWhseActivityLine(var TrackingSpecification: Record "Voucher Tracking Specification"; WhseActivityLine: Record "Warehouse Activity Line");
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterCopyTrackingFromWhseItemTrackingLine(var TrackingSpecification: Record "Voucher Tracking Specification"; WhseItemTrackingLine: Record "Whse. Item Tracking Line")
    begin
    end;

#if not CLEAN25
    internal procedure RunOnAfterInitFromAsmHeader(var TrackingSpecification: Record "Voucher Tracking Specification"; AssemblyHeader: Record Microsoft.Assembly.Document."Assembly Header")
    begin
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterInitFromAsmHeader(var TrackingSpecification: Record "Voucher Tracking Specification"; AssemblyHeader: Record Microsoft.Assembly.Document."Assembly Header")
    begin
    end;
#endif

#if not CLEAN25
    internal procedure RunOnAfterInitFromAsmLine(var TrackingSpecification: Record "Voucher Tracking Specification"; AssemblyLine: Record Microsoft.Assembly.Document."Assembly Line")
    begin
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterInitFromAsmLine(var TrackingSpecification: Record "Voucher Tracking Specification"; AssemblyLine: Record Microsoft.Assembly.Document."Assembly Line")
    begin
    end;
#endif

#if not CLEAN25
    internal procedure RunOnAfterInitFromItemJnlLine(var TrackingSpecification: Record "Voucher Tracking Specification"; ItemJournalLine: Record "Item Journal Line")
    begin
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterInitFromItemJnlLine(var TrackingSpecification: Record "Voucher Tracking Specification"; ItemJournalLine: Record "Item Journal Line")
    begin
    end;
#endif

#if not CLEAN25
    internal procedure RunOnAfterInitFromJobJnlLine(var TrackingSpecification: Record "Voucher Tracking Specification"; JobJournalLine: Record Microsoft.Projects.Project.Journal."Job Journal Line")
    begin
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterInitFromJobJnlLine(var TrackingSpecification: Record "Voucher Tracking Specification"; JobJournalLine: Record Microsoft.Projects.Project.Journal."Job Journal Line")
    begin
    end;
#endif

#if not CLEAN25
    internal procedure RunOnAfterInitFromJobPlanningLine(var TrackingSpecification: Record "Voucher Tracking Specification"; JobPlanningLine: Record Microsoft.Projects.Project.Planning."Job Planning Line")
    begin
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterInitFromJobPlanningLine(var TrackingSpecification: Record "Voucher Tracking Specification"; JobPlanningLine: Record Microsoft.Projects.Project.Planning."Job Planning Line")
    begin
    end;
#endif

#if not CLEAN25
    internal procedure RunOnAfterInitFromPurchLine(var TrackingSpecification: Record "Voucher Tracking Specification"; PurchaseLine: Record "Purchase Line")
    begin
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterInitFromPurchLine(var TrackingSpecification: Record "Voucher Tracking Specification"; PurchaseLine: Record "Purchase Line")
    begin
    end;
#endif

#if not CLEAN25
    internal procedure RunOnAfterInitFromProdOrderLine(var TrackingSpecification: Record "Voucher Tracking Specification"; ProdOrderLine: Record Microsoft.Manufacturing.Document."Prod. Order Line")
    begin
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterInitFromProdOrderLine(var TrackingSpecification: Record "Voucher Tracking Specification"; ProdOrderLine: Record Microsoft.Manufacturing.Document."Prod. Order Line")
    begin
    end;
#endif

#if not CLEAN25
    internal procedure RunOnAfterInitFromProdOrderComp(var TrackingSpecification: Record "Voucher Tracking Specification"; ProdOrderComponent: Record Microsoft.Manufacturing.Document."Prod. Order Component")
    begin
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterInitFromProdOrderComp(var TrackingSpecification: Record "Voucher Tracking Specification"; ProdOrderComponent: Record Microsoft.Manufacturing.Document."Prod. Order Component")
    begin
    end;
#endif

#if not CLEAN25
    internal procedure RunOnAfterInitFromProdPlanningComp(var TrackingSpecification: Record "Voucher Tracking Specification"; PlanningComponent: Record Microsoft.Inventory.Planning."Planning Component")
    begin
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterInitFromProdPlanningComp(var TrackingSpecification: Record "Voucher Tracking Specification"; PlanningComponent: Record Microsoft.Inventory.Planning."Planning Component")
    begin
    end;
#endif

#if  not CLEAN25
    internal procedure RunOnAfterInitFromReqLine(var TrackingSpecification: Record "Voucher Tracking Specification"; RequisitionLine: Record Microsoft.Inventory.Requisition."Requisition Line")
    begin
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterInitFromReqLine(var TrackingSpecification: Record "Voucher Tracking Specification"; RequisitionLine: Record Microsoft.Inventory.Requisition."Requisition Line")
    begin
    end;
#endif

#if not CLEAN25
    internal procedure RunOnAfterInitFromSalesLine(var TrackingSpecification: Record "Voucher Tracking Specification"; SalesLine: Record "Sales Line")
    begin
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterInitFromSalesLine(var TrackingSpecification: Record "Voucher Tracking Specification"; SalesLine: Record "Sales Line")
    begin
    end;
#endif

#if not CLEAN25
    internal procedure RunOnAfterInitFromServLine(var TrackingSpecification: Record "Voucher Tracking Specification"; ServiceLine: Record Microsoft.Service.Document."Service Line")
    begin
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterInitFromServLine(var TrackingSpecification: Record "Voucher Tracking Specification"; ServiceLine: Record Microsoft.Service.Document."Service Line")
    begin
    end;
#endif

#if not CLEAN25
    internal procedure RunOnAfterInitFromTransLine(var TrackingSpecification: Record "Voucher Tracking Specification"; TransferLine: Record Microsoft.Inventory.Transfer."Transfer Line"; Direction: Enum Microsoft.Foundation.Enums."Transfer Direction")
    begin
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterInitFromTransLine(var TrackingSpecification: Record "Voucher Tracking Specification"; TransferLine: Record Microsoft.Inventory.Transfer."Transfer Line"; Direction: Enum Microsoft.Foundation.Enums."Transfer Direction")
    begin
    end;
#endif

    [IntegrationEvent(false, false)]
    local procedure OnAfterInitQtyToInvoice(var TrackingSpecification: Record "Voucher Tracking Specification")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterInitQtyToShip(var TrackingSpecification: Record "Voucher Tracking Specification")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterInitExpirationDate(var TrackingSpecification: Record "Voucher Tracking Specification")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterCopyTrackingFromEntrySummary(var TrackingSpecification: Record "Voucher Tracking Specification"; EntrySummary: Record "Entry Summary")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterCopyTrackingFromItemLedgEntry(var TrackingSpecification: Record "Voucher Tracking Specification"; ItemLedgerEntry: Record "Item Ledger Entry")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterCopyTrackingFromItemTrackingSetup(var TrackingSpecification: Record "Voucher Tracking Specification"; ItemTrackingSetup: Record "Item Tracking Setup")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterCopyTrackingFromTrackingSpec(var TrackingSpecification: Record "Voucher Tracking Specification"; FromTrackingSpecification: Record "Voucher Tracking Specification")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterCopyNewTrackingFromTrackingSpec(var TrackingSpecification: Record "Voucher Tracking Specification"; FromTrackingSpecification: Record "Voucher Tracking Specification")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterCopyNewTrackingFromNewTrackingSpec(var TrackingSpecification: Record "Voucher Tracking Specification"; FromTrackingSpecification: Record "Voucher Tracking Specification")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterSetTrackingBlank(var TrackingSpecification: Record "Voucher Tracking Specification")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterSetTrackingFilterBlank(var TrackingSpecification: Record "Voucher Tracking Specification")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterSetTrackingFilterFromEntrySummary(var TrackingSpecification: Record "Voucher Tracking Specification"; EntrySummary: Record "Entry Summary")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterSetTrackingFilterFromItemJnlLine(var TrackingSpecification: Record "Voucher Tracking Specification"; ItemJournalLine: Record "Item Journal Line")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterSetTrackingFilterFromItemTrackingSetup(var TrackingSpecification: Record "Voucher Tracking Specification"; ItemTrackingSetup: Record "Item Tracking Setup")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterSetTrackingFilterFromItemLedgEntry(var TrackingSpecification: Record "Voucher Tracking Specification"; ItemLedgerEntry: Record "Item Ledger Entry")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterSetTrackingFilterFromReservEntry(var TrackingSpecification: Record "Voucher Tracking Specification"; ReservationEntry: Record "Reservation Entry")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterSetNewTrackingFilterFromNewReservEntry(var TrackingSpecification: Record "Voucher Tracking Specification"; ReservationEntry: Record "Reservation Entry")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterSetNewTrackingFilterFromNewTrackingSpec(var TrackingSpecification: Record "Voucher Tracking Specification"; FromTrackingSpecification: Record "Voucher Tracking Specification")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterSetTrackingFilterFromTrackingSpec(var TrackingSpecification: Record "Voucher Tracking Specification"; FromTrackingSpecification: Record "Voucher Tracking Specification")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterSetNonSerialTrackingFilterFromSpec(var TrackingSpecification: Record "Voucher Tracking Specification"; FromTrackingSpecification: Record "Voucher Tracking Specification")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterSetSourceFilter(var TrackingSpecification: Record "Voucher Tracking Specification"; SourceType: Integer; SourceSubtype: Integer; SourceID: Code[20]; SourceRefNo: Integer; SourceKey: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterSetTrackingFilterFromWhseActivityLine(var TrackingSpecification: Record "Voucher Tracking Specification"; WhseActivityLine: Record "Warehouse Activity Line")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterLookupApplFromItemEntrySetFilters(var ItemLedgerEntry: Record "Item Ledger Entry"; TrackingSpecification: Record "Voucher Tracking Specification")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterTestTrackingFieldsAreBlank(var TrackingSpecification: Record "Voucher Tracking Specification")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterTrackingExist(var TrackingSpecification: Record "Voucher Tracking Specification"; var IsTrackingExist: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterNonSerialTrackingExists(var TrackingSpecification: Record "Voucher Tracking Specification"; var IsTrackingExists: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterHasSameTracking(var TrackingSpecification: Record "Voucher Tracking Specification"; FromTrackingSpecification: Record "Voucher Tracking Specification"; var IsSameTracking: Boolean);
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterValidateApplFromItemEntry(var TrackingSpecification: Record "Voucher Tracking Specification"; ItemLedgerEntry: Record "Item Ledger Entry"; IsReclassification: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeCheckSerialNoQty(var TrackingSpecification: Record "Voucher Tracking Specification"; var IsHandled: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeClearApplyToEntryIfQuantityToInvoiceIsNotSufficient(var TrackingSpecification: Record "Voucher Tracking Specification"; var IsHandled: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeInitQtyToInvoice(var TrackingSpecification: Record "Voucher Tracking Specification")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeInitQtyToShip(var TrackingSpecification: Record "Voucher Tracking Specification"; var IsHandled: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeTestApplyToItemLedgEntry(var TrackingSpecification: Record "Voucher Tracking Specification"; ItemLedgerEntry: Record "Item Ledger Entry"; var IsHandled: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnCheckPackageNo(TrackingSpecification: Record "Voucher Tracking Specification"; PackageNo: Code[50])
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeUpdateTrackingSpecification(var TrackingSpecification: Record "Voucher Tracking Specification"; var FromTrackingSpecification: Record "Voucher Tracking Specification")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnValidateQtyToHandleOnBeforeInitQtyToInvoice(var TrackingSpecification: Record "Voucher Tracking Specification"; xTrackingSpecification: Record "Voucher Tracking Specification"; CallingFieldNo: Integer)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnValidateApplFromItemEntryOnSourceTypeCaseElse(var TrackingSpecification: Record "Voucher Tracking Specification"; var IsHandled: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeCheckItemTrackingQuantity(var TrackingSpecification: Record "Voucher Tracking Specification"; TableNo: Integer; DocumentType: Option; DocumentNo: Code[20]; LineNo: Integer; ProdOrderLineNo: Integer; var QtyToHandleBase: Decimal; var QtyToInvoiceBase: Decimal; var Handle: Boolean; var Invoice: Boolean; var IsHandled: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterSetSourceFromPurchLine(var TrackingSpecification: Record "Voucher Tracking Specification"; PurchLine: Record "Purchase Line")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterSetSourceFromSalesLine(var TrackingSpecification: Record "Voucher Tracking Specification"; SalesLine: Record "Sales Line")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeInitExpirationDate(var TrackingSpecification: Record "Voucher Tracking Specification"; xRec: Record "Voucher Tracking Specification"; var IsHandled: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeOnDelete(var TrackingSpecification: Record "Voucher Tracking Specification"; xTrackingSpecification: Record "Voucher Tracking Specification"; var IsHandled: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeSetTrackingKey(var TrackingSpecification: Record "Voucher Tracking Specification"; var IsHandled: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterIsReclass(TrackingSpecification: Record "Voucher Tracking Specification"; var Reclass: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterCheckItemTrackingQuantity(var TrackingSpecification: Record "Voucher Tracking Specification"; var ReservationEntry: Record "Reservation Entry"; TableNo: Integer; DocumentType: Option; DocumentNo: Code[20]; LineNo: Integer)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterCheckSerialNoQty(var TrackingSpecification: Record "Voucher Tracking Specification")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnValidateQuantityBaseOnBeforeCheckItemTrackingChange(var TrackingSpecification: Record "Voucher Tracking Specification"; CallingFieldNo: Integer; var IsHandled: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnValidateExpirationDateOnBeforeResetExpirationDate(var TrackingSpecification: Record "Voucher Tracking Specification"; xTrackingSpecification: Record "Voucher Tracking Specification"; var IsHandled: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeCheckApplyFromItemEntrySourceType(var TrackingSpecification: Record "Voucher Tracking Specification"; var IsHandled: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnGetSourceShipmentDate(var TrackingSpecification: Record "Voucher Tracking Specification"; var ShipmentDate: Date);
    begin
    end;
}
