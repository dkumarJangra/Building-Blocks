table 97863 "Unit Payment Entry new"
{
    ...
    begin
        ...
        IF ("Payment Mode" <> "Payment Mode"::Cash) AND ("Payment Mode" <> "Payment Mode"::MJVM) THEN BEGIN
    ...
    var
        BondSetup: Record "Unit Setup";
        PaymentLines: Record "Unit Payment Entry new";
        CashAmount: Decimal;
    begin
    ...
    var
        PmtLines: Record "Unit Payment Entry new";
    begin
        IF "Document Type" <> "Document Type"::Application THEN
            EXIT;
