table 97836 "Travel Setup Line"
{
    ...
    fields
    {
        ...
        field(13; "Region/Rank Code"; Code[10])
        {
            CalcFormula = Lookup(Job."Region Code for Rank Hierarcy" WHERE("No." = FIELD("Project Code")));
            Editable = false;
    ...
    keys
    {
        key(Key1; "Associate Code", "Effective Date", "Project Code")
        {
            Clustered = true;
        }
