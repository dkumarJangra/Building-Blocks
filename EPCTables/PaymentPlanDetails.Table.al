table 97777 "Payment Plan Details"
{
    ...
    fields
    {
        ...
        field(50000; "Send SMS Cust for Due Amount"; Boolean)
        {
            Description = 'BBG2.00 120814';
        }
        field(50001; "Sub Payment Plan"; Code[20])
        {
        ...
        field(50101; "Buffer Days for AutoPlot Vacat"; DateFormula)
        {
            DataClassification = ToBeClassified;
        }
        field(50102; "Auto Plot Vacate Due Date"; Date)
        {
            DataClassification = ToBeClassified;
            Editable = false;
        }
    ...
    keys
    {
        key(Key1; "Project Code", "Payment Plan Code", "Milestone Code", "Charge Code", "Document No.", "Sale/Lease", "Sub Payment Plan")
        {
            Clustered = true;
        ...
        key(Key4; "Project Code", "Payment Plan Code", "Sub Payment Plan", "Due Date Calculation", "Milestone Code")
        {
        }
    }
