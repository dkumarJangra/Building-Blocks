table 97853 "Incentive Summary"
{
    ...
    fields
    {
        ...
        field(50002; "No. of plot"; Decimal)
        {
        }
        field(50003; "Parent Code"; Code[20])
        {
        }
        field(50004; "Including Team No. of Plot"; Decimal)
        {
        }
        ...
        field(50012; "Club 9 Amount"; Decimal)
        {
        ...
        field(50014; "Adjust Remaining Amt"; Boolean)
        {
            Description = 'BBG1.00 210413';
        }
        field(50015; "Post Payment"; Boolean)
        {
        }
        field(50016; "Team Dim"; Code[20])
        {
            Description = 'BBG1.00 160713';
            Editable = false;
            TableRelation = Vendor;
        }
        field(50017; "BSP1_BSP3 Amount"; Decimal)
        {
            Description = 'BBG1.00 290713';
            Editable = false;
        }
        field(50018; "Incentive Not Applicable"; Boolean)
        {
    ...
    keys
    {
        ...
        key(Key8; "Associate Code", "Calculation Type", Month, Year, Type)
        {
        }
        key(Key9; "Associate Code", "Voucher No.")
        {
            SumIndexFields = "Payable Incentive Amount";
        }
    }
    ...
    begin
        IF "Incentive Application No." = '' THEN BEGIN
            UnitSetup.GET;
            UnitSetup.TESTFIELD("Post Inct Summary No.");
            // NoSeriesMgt.InitSeries(UnitSetup."Post Inct Summary No.", xRec."Incentive No. Series", WORKDATE, "Incentive Application No.",
            //"Incentive No. Series");  //Old code commented 07032026 
            "Incentive Application No." := NoSeriesMgt.GetNextNo(UnitSetup."Post Inct Summary No.", WorkDate, true);  //New code added 07032026 
        END;
    end;
