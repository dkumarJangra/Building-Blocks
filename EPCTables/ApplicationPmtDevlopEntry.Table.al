table 50048 "Application Pmt Devlop. Entry"
{
    ...
    fields
    {
        ...
        field(7; Amount; Decimal)
        {
            ...
            begin
                ...
                "Payment Mode"::"Negative Adjmt.", "Payment Mode"::JV, "Payment Mode"::MJVM]) AND (Amount < 0) THEN
    ...
    var
        ...
        BPayEntry: Record "Application Pmt Devlop. Entry";
        ...
        AppEntry_1: Record "Application Pmt Devlop. Entry";
        Vend: Record Vendor;
        TDSP: Decimal;
        ClubP: Decimal;
        ...
        AppPaymentEntry: Record "Application Pmt Devlop. Entry";
        LastLineNo: Integer;
        InsertAppLines: Record "Application Pmt Devlop. Entry";
    ...
    var
        BondSetup: Record "Unit Setup";
        PaymentLines: Record "Application Pmt Devlop. Entry";
        CashAmount: Decimal;
    begin
    ...
    var
        PmtLines: Record "Application Pmt Devlop. Entry";
    begin
        IF "Document Type" <> "Document Type"::Application THEN
            EXIT;
