table 97787 "Purch. Delivery Schedule"
{
    // ALLETG RIL0011 22-06-2011:

    DrillDownPageID = "Purchase Delivery List Form";
    LookupPageID = "Purchase Delivery List Form";
    ...
    fields
    {
        ...
        field(11; "Schedule Quantity"; Decimal)
        {
            ...
            begin
                ...
                CheckQuantity;
                "Remaining Quantity" := "Schedule Quantity" - "Received Quantity";
    ...
    keys
    {
        ...
        {
            Clustered = true;
            SumIndexFields = "Schedule Quantity";
        }
    }
