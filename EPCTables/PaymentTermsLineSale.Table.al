table 97778 "Payment Terms Line Sale"
{
    ...
    fields
    {
        ...
        field(11; "Due Date Calculation"; DateFormula)
        {
            ...
            begin
                ...
                IF Application.GET("Document No.") THEN BEGIN
                    ...
                    IF FORMAT("Buffer Days for AutoPlot Vacat") <> '' THEN
                        "Auto Plot Vacate Due Date" := CALCDATE("Buffer Days for AutoPlot Vacat", "Due Date")
                    ELSE
                        "Auto Plot Vacate Due Date" := "Due Date";
                END;  //ALLEDK 040821
        ...
        field(50035; "Buffer Days"; DateFormula)
        {
        }
        ...
        field(50244; "Buffer Days for AutoPlot Vacat"; DateFormula)
        {
            DataClassification = ToBeClassified;
            Editable = true;
        ...
        field(50245; "Auto Plot Vacate Due Date"; Date)
        {
            DataClassification = ToBeClassified;
            Editable = false;
        }
        ...
        {
            CalcFormula = Sum("Unit Payment Entry".Amount WHERE("Document No." = FIELD("Document No."),
    ...
    keys
    {
        ...
        key(Key9; "Document No.", "Direct Associate")
        {
            SumIndexFields = "Due Amount";
        }
    }
