report 97781 "Appl. Management Proxy"
{
    // version Done

    DefaultLayout = RDLC;
    RDLCLayout = './Reports/Appl. Management Proxy.rdl';
    ApplicationArea = All;
    ...
    procedure Load(ApplNo: Integer; var DocumentRec: Record Document; Caption: Text[128]; ViewOnly: Boolean)
    begin
    end;
