report 97807 "Document Management"
{
    // version Done

    DefaultLayout = RDLC;
    RDLCLayout = './Document Management.rdl';
    ApplicationArea = All;
    ...
    var
        ...
        AppMgt: Report "Appl. Management Proxy";
    ...
    procedure Edit(var DocumentRec: Record Document): Boolean
    begin
    ...
    procedure View(var DocumentRec: Record Document): Boolean
    begin
        // Save old document first if any
        IF NOT Finish(FALSE) THEN
            EXIT(FALSE);
    ...
    procedure Replace(var DocumentRec: Record Document): Boolean
    var
        i: Integer;
        Value: Text[250];
