page 50142 "Application Development Card"
{
    DeleteAllowed = false;
    InsertAllowed = false;
    PageType = Document;
    ...
    layout
    {
        area(content)
        {
            ...
            part("Receipt Lines"; "Application Developmnt Subform")
            {
                        ...
                        IF CONFIRM(STRSUBSTNO(Text50002, Rec.FIELDCAPTION("Application No."), Rec."Application No.",
                           ...
                           PaymentAmt, AmountText1[1], AppPayEntry."Posting date")) THEN BEGIN
                            IF CONFIRM(Text006) THEN BEGIN
                                ...
                                AppPaymentEntryNew.RESET;
                                AppPaymentEntryNew.SETRANGE("Document No.", Rec."No.");
                                IF AppPaymentEntryNew.FINDLAST THEN
                                    AppPaymentEntryNew.Posted := TRUE;
                                AppPaymentEntryNew."Posted Document No." := PostedDocNo;
                                    ...
                                    IF Customer."BBG Mobile No." <> '' THEN BEGIN
                                        ...
                                        IF AppPayEntry.FINDLAST THEN BEGIN
                                            IF (AppPayEntry.Amount <> 0) THEN BEGIN
                                                ...
                                                SMSLogDetails.SMSValue(SmsMessage, SmsMessage1, 'Customer', Customer."No.", Customer.Name, 'Customer Receipt Development', Rec."Shortcut Dimension 1 Code", GetDescription.GetDimensionName(Rec."Shortcut Dimension 1 Code", 1), Rec."No.");
                                                //ALLEDK15112022 END
                ...
                action(Receipt)
                {
                    ...
                    begin
                        ...
                        IF AppPaymentEntry.FINDLAST THEN BEGIN
                          ConfReport3.SetPostFilter("No.",AppPaymentEntry."Posted Document No.");
                          ConfReport3.RUN;
                        END;
                        Bond.RESET;
                        */  //050621
