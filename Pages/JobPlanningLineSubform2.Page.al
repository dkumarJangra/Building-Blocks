page 50001 "Job Planning Line Subform2"
{
    AutoSplitKey = true;
    ...
    begin
        //TESTFIELD(Transferred,FALSE); // ALLE MM Code Commented
    ...
    var
        JobCreateInvoice: Codeunit "Job Create-Invoice";
    begin
        //JobCreateInvoice.GetSalesInvoice(Rec); // ALLE MM Code Commented
        JobCreateInvoice.GetJobPlanningLineInvoices(Rec); // ALLE MM Code Added
    end;

    local procedure BBGOnAfterGetCurrRecord()
    begin
        xRec := Rec;
        //SetEditable(NOT Transferred); // ALLE MM Code Commented
    end;
}
