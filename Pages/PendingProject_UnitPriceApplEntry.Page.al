page 50416 "Pending Proj/Unit App. List"
{
    Caption = 'Pending Project/Unit Approval Entries';
    DeleteAllowed = false;
    Editable = false;
    InsertAllowed = false;
    PageType = List;
    ...
    SourceTableView = SORTING("Entry No.") where("Final Proj/Unit Price approver" = filter(<> ''),
