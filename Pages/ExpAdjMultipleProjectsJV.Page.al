page 50005 "Exp. Adj. Multiple Projects JV"
{
    ...
    AutoSplitKey = true;
    Caption = 'Exp. Adj. Multiple Projects JV';
    ...
    begin
        ...
        Rec."Posting Type" := Rec."Posting Type"::Running;
    ...
    begin
        ...
        */
        GenJnlManagement.TemplateSelection(PAGE::"Exp. Adj. Multiple Projects JV", 0, FALSE, Rec, JnlSelected);
    ...
    begin
        ...
        IF Rec."TDS Section Code" <> '' THEN // "TDS Nature of Deduction"
            TDSAmount := JnlLine."GST TDS/TCS Base Amount (LCY)";// "Total TDS/TCS Incl. SHE CESS";
        IF Rec."TCS Nature of Collection" <> '' THEN
            TCSAmount := JnlLine."GST TDS/TCS Base Amount (LCY)";// "Total TDS/TCS Incl. SHE CESS";
