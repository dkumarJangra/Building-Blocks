page 50389 "G/S Voucher Rec from Customer"
{


    Caption = 'Gold/Silver Voucher Recovery from customer';
    PageType = Card;
    ...
    actions
    {
        area(navigation)
        {
            ...
            group("&GIN")
            {
                ...
                action("Return Gold/Silver Voucher")
                {
                    Caption = 'Return Gold/Silver Voucher';
                ...
                action("Verify Gold/Silver Voucher")
                {
                    Caption = 'Verify Gold/Silver Voucher';
                ...
                action("Return Verified Gold/Silver Voucher")
                {
                    Caption = 'Return Verified Gold/Silver Voucher';
    ...
    begin
        ...
        Rec."Item Type" := Rec."Item Type"::Gold_SilverVoucher;  //17042025 Code added
        RecRespCenter.RESET;
        RecRespCenter.SETRANGE(Code, Rec."Responsibility Center");
        IF RecRespCenter.FIND('-') THEN BEGIN
            Respname := RecRespCenter.Name;
