...
page 50446 "Inter Purchase Invoices"
{
    ...
    SourceTableView = where("Document Type" = const(Invoice), "Inter Purchase Document" = const(true));
    UsageCategory = Lists;
    ...
    actions
    {
        ...
        area(processing)
        {
            group(Invoice)
            {
                ...
                Action(CreateNewDocument)
                {
                    ...
                    begin
                        PurchSetup.get;
                        PurchSetup.TestField("Inter Purchase No.Seires");
                        PurchSetup.TestField("Posted Inter Purch. No.Seires");
                        PurchHeader.init;
        ...
        area(Promoted)
        {
            ...
            group(Category_New)
            {
                actionref(CreateNew_Document; CreateNewDocument)  //Added new 28122028
                { }
            }
