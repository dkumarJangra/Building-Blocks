page 50236 "Gold/Silver VoucherEligibility"
{
    Caption = 'Gold/Silver Voucher Elegibility';
            ...
            group("Calculate Eligibility")
            {
                ...
                action("Calculate &Eligibility")
                {
                    ...
                    begin
                        ...
                        GenerateCoinEntry.SetValues(CustNoFilter, ProjectCodeFilter);
    ...
    var
        ...
        GenerateCoinEntry: Report "Generate G/S VoucherEntry";
