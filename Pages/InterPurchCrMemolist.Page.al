...
page 50464 "Inter Purchase Credit Memos"
{
    ...
    SourceTableView = where("Document Type" = const("Credit Memo"), "Inter purchase document" = const(true));
    UsageCategory = Lists;
    ...
    actions
    {
        ...
        area(processing)
        {
            ...
            {
                ApplicationArea = All;
                Caption = 'Create Inter Purchase Credit Memo Document';
                Image = New;
                trigger OnAction()
                var
                ...
                begin
                    ...
                    PurchHeader."no. series" := PurchSetup."Inter Purchase Cr. No.Seires";
                    PurchHeader."Inter Purchase Document" := True;
                    PurchHeader."Posting No. Series" := PurchSetup."Posted Inter Purch CrMemo NoSr";
