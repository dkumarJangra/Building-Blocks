page 50237 "Direct Gold/Silver VoucherList"
{
    Caption = 'Direct Gold/Silver Voucher issue list';
    CardPageID = "Gold/Silver Voucher Direct";
    Editable = false;
    PageType = List;
    ...
    SourceTableView = SORTING("Document Type", "Document No.")
                      ...
                      WHERE("Document Type" = FILTER(MIN),
                            Status = FILTER(Open),
                            Type = CONST(Direct),
                            "Item Type" = filter('Gold_SilverVoucher'));  //09042025 Added filter
    UsageCategory = Lists;
    ApplicationArea = All;
