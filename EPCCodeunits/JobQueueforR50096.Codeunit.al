codeunit 97743 "Job Queue for R-50096"
{
    ...
    begin
        ...
        Vend.SETRANGE("BBG Report 50096 Run for Associate", TRUE);
        //Vend.SETRANGE("No.",'IBA0246489');
    ...
    var
        Vend: Record Vendor;
        Codeunit_12: Codeunit "Job Queue for R-50096_1";
        ErrorText: Text[30];
