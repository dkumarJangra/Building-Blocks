codeunit 97742 "Job Queue for R-50082"
{
    ...
    begin
        ...
        Vend.SETRANGE("BBG Report 50082 Run for Associate", TRUE);
        IF Vend.FINDSET THEN
            REPEAT
                CLEAR(Codeunit_12);
                Codeunit_12.Setfilteres(Vend."No.", BatchNo);
                IF NOT Codeunit_12.RUN(Vend) THEN BEGIN
                    ...
                    "ReportDataforE-Mail"."Report ID" := 50082;
    ...
    var
        Vend: Record Vendor;
        Codeunit_12: Codeunit "Job Queue for R-50082_1";
