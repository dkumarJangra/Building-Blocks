codeunit 97741 "Job Queue for R-50041"
{
    ...
    begin
        ...
        Vend.SETRANGE("BBG Report 50041 Run for Associate", TRUE);
        IF Vend.FINDSET THEN
            REPEAT
                CLEAR(Codeunit_12);
                Codeunit_12.Setfilteres(Vend."No.", BatchNo, 0D, 0D, 0);
    ...
    var
        Vend: Record Vendor;
        Codeunit_12: Codeunit "Job Queue for R-50041_1";
