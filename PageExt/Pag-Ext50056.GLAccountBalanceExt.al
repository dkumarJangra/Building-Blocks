pageextension 50056 "BBG G/L Account Balance Ext" extends "G/L Account Balance"
{
    layout
    {
    ...
    BEGIN
        ...
        //BBG1.00 ALLEDK 060313
        //   IF OpenForm THEN BEGIN
        //     IF NOT TableSecurity.GetTableSecurity(FORM::"G/L Account Balance") THEN
        //       EXIT;
