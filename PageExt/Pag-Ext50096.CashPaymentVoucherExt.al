pageextension 50096 "BBG Cash Payment Voucher Ext" extends "Cash Payment Voucher"
{
    layout
    {
        ...
        moveafter("Introducer Code"; "Currency Code")
